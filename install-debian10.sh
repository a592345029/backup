...
mkdir fastgit-tmp
cd fastgit-tmp
git clone http://hk.xyxygz.tk:666/https://github.com/FastGitORG/nginx-conf --depth=1
...
if $isInstallFront; then
    git clone "http://hk.xyxygz.tk:666/https://github.com/FastGitORG/www" /www/wwwroot/fgorg
